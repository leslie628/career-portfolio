...
const BusinessImpact = () => {
    return (
        <>
            <h1 className="text-3xl flex justify-center font-bold text-blue-600">Business benefits of architecture</h1>
                ...
                <div className="relative shadow-lg rounded-lg p-3 group cursor-pointer">
                    ...
                    <ul className="p-4 space-y-2">
                        ...
                        <li className="flex items-start gap-2">
                            <span className="text-red-600 mt-1">✖</span>
                            <span>
                                One feature change can break the entire app, so regression testing overhead is high.
                            </span>
                        </li>
                    </ul>
                </div>
                ...
                <div className="relative shadow-lg rounded-lg p-3 group cursor-pointer">
                    ...
                    <ul className="p-4 space-y-2">
                        ...
                        <li className="flex items-start gap-2">
                            <span className="text-green-600 mt-1">✔</span>
                            <span>
                                One feature change won’t break the entire application → Lower risk & increased reliability.
                            </span>
                        </li>
